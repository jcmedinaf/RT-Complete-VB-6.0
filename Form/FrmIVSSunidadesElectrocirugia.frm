...
Begin VB.Form FrmIVSSunidadesElectrocirugia 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Unidades de Electrocirugia"
   ClientHeight    =   9315
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   14745
   Icon            =   "FrmIVSSunidadesElectrocirugia.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   9315
   ...
   End
End
Attribute VB_Name = "FrmIVSSunidadesElectrocirugia"
