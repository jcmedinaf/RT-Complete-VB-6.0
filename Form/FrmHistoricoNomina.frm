...
Begin VB.Form FrmHistoricoNomina 
   BackColor       =   &H00EAEFEF&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Historico de la Nómina"
   ClientHeight    =   7035
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   13740
   Icon            =   "FrmHistoricoNomina.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7035
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.TextBox TxtRecibo 
            ...
            TabIndex        =   9
            Text            =   "Busqueda"
            ToolTipText     =   "Ingrese el Número del Recibo a buscar"
            Top             =   240
            Width           =   1935
         End
         Begin ChamaleonButton.ChameleonBtn BtnBuscarRecibo 
            ...
            MCOL            =   16777215
            MPTR            =   1
            MICON           =   "FrmHistoricoNomina.frx":1002
            PICN            =   "FrmHistoricoNomina.frx":101E
            PICH            =   "FrmHistoricoNomina.frx":1283
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
      ...
      Begin VB.Frame Frame4 
         ...
         Begin ChamaleonButton.ChameleonBtn BtnBuscar 
            ...
            MCOL            =   16777215
            MPTR            =   1
            MICON           =   "FrmHistoricoNomina.frx":1515
            PICN            =   "FrmHistoricoNomina.frx":1531
            PICH            =   "FrmHistoricoNomina.frx":1796
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
      ...
      Begin VB.Frame Frame2 
         ...
         Begin ChamaleonButton.ChameleonBtn BtnCerrar 
            ...
            MCOL            =   16777215
            MPTR            =   1
            MICON           =   "FrmHistoricoNomina.frx":1A28
            PICN            =   "FrmHistoricoNomina.frx":1A44
            PICH            =   "FrmHistoricoNomina.frx":1C0D
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin ChamaleonButton.ChameleonBtn BtnImprimir 
            ...
            MCOL            =   16777215
            MPTR            =   1
            MICON           =   "FrmHistoricoNomina.frx":1E42
            PICN            =   "FrmHistoricoNomina.frx":1E5E
            PICH            =   "FrmHistoricoNomina.frx":1F83
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "FrmHistoricoNomina"
...
With CrystalReport1
    .ReportFileName = RutaInformes & "\ResumenNominaH.rpt"
    'MsgBox RutaInformes & "\ResumenNominaH.rpt"
    ...
    .RetrieveDataFiles
    .ReportSource = 0
    '.SelectionFormula = "{ReciboDePago2.Periodo} = " & Periodo & "  And {ReciboDePago2.Fecha_Gen} = " & FechaSQL(Fecha1) & ""
    .SelectionFormula = "{ReciboDePago2.Periodo} = " & Periodo & "  And {ReciboDePago2.Fecha_Fin_Nom} = " & FechaSQL(Fecha2) & ""
    'MsgBox .SelectionFormula
    .WindowTitle = "Historico de Nomina"
...
If Button = vbRightButton Then
    ...
    If Not IsNull(TempId) Then
        If Trim(TempId) <> "" Then
            ...
            FrmReciboPagos.BtnBorrar.Enabled = False
            'FrmReciboPagos.BtnBuscar.Enabled = False
            FrmReciboPagos.BtnDesHacer.Enabled = False
            FrmReciboPagos.BtnGuardarActualizar.Enabled = False
...
If Not IsNull(Fecha1) Then
    If Trim(Fecha1) <> "" Then
        ...
        CSql = "SELECT Historico_Nomina.*, Empleados.Nombre, Empleados.Apellido FROM Historico_Nomina INNER JOIN " & _
               " Empleados ON Historico_Nomina.IdEmpleado = Empleados.IdEmpleado WHERE Fecha_Ini_Nom='" & Fecha1 & "' " & _
               " AND Fecha_Fin_Nom='" & Fecha2 & "' ORDER BY Historico_Nomina.IdHistorico"
        ...
        While Not RsTemp.EOF
            ...
            DMGrid2.ValorCelda(DMGrid2.Rows, 1) = RsTemp.Fields("IdHistorico").Value
...
CSql = "SELECT Fecha_Ini_Nom, Fecha_Fin_Nom, Periodo FROM Historico_Nomina GROUP BY Fecha_Ini_Nom, Fecha_Fin_Nom, Periodo"
Set RsTemp = CrearRS(CSql)

If RsTemp.RecordCount = 0 Then MsgBox "No hay nóminas creadas!", vbExclamation + vbOKOnly, "Nómina vacía": Exit Sub
