...
Begin VB.Form FrmImprimirConsultaPsicologicaAdultos 
   BackColor       =   &H00EAEFEF&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Imprimir Consulta Psicologica Adulto"
   ClientHeight    =   2835
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   4380
   Icon            =   "FrmImprimirConsultaPsicologicaAdultos.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   2835
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin ChamaleonButton.ChameleonBtn BtnCerrar 
            ...
            MCOL            =   16777215
            MPTR            =   1
            MICON           =   "FrmImprimirConsultaPsicologicaAdultos.frx":1002
            PICN            =   "FrmImprimirConsultaPsicologicaAdultos.frx":101E
            PICH            =   "FrmImprimirConsultaPsicologicaAdultos.frx":11E7
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin ChamaleonButton.ChameleonBtn BtnImprimir 
            ...
            MCOL            =   16777215
            MPTR            =   1
            MICON           =   "FrmImprimirConsultaPsicologicaAdultos.frx":141C
            PICN            =   "FrmImprimirConsultaPsicologicaAdultos.frx":1438
            PICH            =   "FrmImprimirConsultaPsicologicaAdultos.frx":155D
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "FrmImprimirConsultaPsicologicaAdultos"
...
CrystalReport1.WindowTitle = "Reporte Psicologia Adulto"
FmlaText$ = "{Historia_clinica.cedula}=" & FrmConsultaPsicologicaAdult.Text1.Text
CrystalReport1.SelectionFormula = FmlaText$
CrystalReport1.ReportFileName = RutaInf & "\" & "PsicologiaA.rpt"

'CrystalReport1.ReportFileName = Direc & "\Informes\Historia Clinica Integral.rpt"
'sele = "{Historia_clinica.cedula}=" & Text1.Text
