...
Begin VB.Form FrmImprimirConsultaPsicologicaNinos 
   BackColor       =   &H00EAEFEF&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Imprimir Consulta Psicologica Niños"
   ClientHeight    =   2865
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   4395
   Icon            =   "FrmImprimirConsultaPsicologicaNinos.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   2865
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin ChamaleonButton.ChameleonBtn BtnCerrar 
            ...
            MCOL            =   16777215
            MPTR            =   1
            MICON           =   "FrmImprimirConsultaPsicologicaNinos.frx":1002
            PICN            =   "FrmImprimirConsultaPsicologicaNinos.frx":101E
            PICH            =   "FrmImprimirConsultaPsicologicaNinos.frx":11E7
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin ChamaleonButton.ChameleonBtn BtnImprimir 
            ...
            MCOL            =   16777215
            MPTR            =   1
            MICON           =   "FrmImprimirConsultaPsicologicaNinos.frx":141C
            PICN            =   "FrmImprimirConsultaPsicologicaNinos.frx":1438
            PICH            =   "FrmImprimirConsultaPsicologicaNinos.frx":155D
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "FrmImprimirConsultaPsicologicaNinos"
...
CrystalReport1.WindowTitle = "Reporte Psicologia Niños"
FmlaText$ = "{Historia_clinica.cedula}=" & FrmConsultaPsicologicaNoA.Text1.Text
CrystalReport1.SelectionFormula = FmlaText$
CrystalReport1.ReportFileName = RutaInf & "\" & "PsicologiaN.rpt"
