...
Begin VB.Form FrmTransaccionNotaCredito 
   BackColor       =   &H00EAEFEF&
   ...
   ClientTop       =   435
   ClientWidth     =   8865
   Icon            =   "FrmTransaccionNotasCreditos.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   2850
   ...
   Begin VB.Frame Frame7 
      ...
      Begin ChamaleonButton.ChameleonBtn BtnCerrar 
         ...
         MCOL            =   16777215
         MPTR            =   1
         MICON           =   "FrmTransaccionNotasCreditos.frx":1002
         PICN            =   "FrmTransaccionNotasCreditos.frx":101E
         PICH            =   "FrmTransaccionNotasCreditos.frx":11E7
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonButton.ChameleonBtn BtnAgregar 
         ...
         MCOL            =   16777215
         MPTR            =   1
         MICON           =   "FrmTransaccionNotasCreditos.frx":141C
         PICN            =   "FrmTransaccionNotasCreditos.frx":1438
         PICH            =   "FrmTransaccionNotasCreditos.frx":15C5
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonButton.ChameleonBtn BtnDesHacer 
         ...
         MCOL            =   16777215
         MPTR            =   1
         MICON           =   "FrmTransaccionNotasCreditos.frx":17FA
         PICN            =   "FrmTransaccionNotasCreditos.frx":1816
         PICH            =   "FrmTransaccionNotasCreditos.frx":1AF8
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonButton.ChameleonBtn BtnGuardarActualizar 
         ...
         MCOL            =   16777215
         MPTR            =   1
         MICON           =   "FrmTransaccionNotasCreditos.frx":1D49
         PICN            =   "FrmTransaccionNotasCreditos.frx":1D65
         PICH            =   "FrmTransaccionNotasCreditos.frx":1FF4
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin VB.Frame Frame2 
      ...
      Begin ChamaleonButton.ChameleonBtn BtnBuscar 
         ...
         MCOL            =   16777215
         MPTR            =   1
         MICON           =   "FrmTransaccionNotasCreditos.frx":2435
         PICN            =   "FrmTransaccionNotasCreditos.frx":2451
         PICH            =   "FrmTransaccionNotasCreditos.frx":26B6
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "FrmTransaccionNotaCredito"
...
RsGuardar.Fields("n_comprobante").Value = TxtNoCredito.Text
...
'///////////////////////////////////Valido TextBox: TxtNoCredito//////////////////////////////
Private Sub TxtNoCredito_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then
