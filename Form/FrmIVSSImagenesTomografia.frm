...
Begin VB.Form FrmIVSSImagenesTomografia 
   Caption         =   "Tomografía"
   ClientHeight    =   9285
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   14700
   Icon            =   "FrmIVSSImagenesTomografia.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   9285
   ScaleWidth      =   14700
   ...
   End
End
Attribute VB_Name = "FrmIVSSImagenesTomografia"
...
'If ListView1.ListItems.Count > 0 Then
    ...
    'CSql = "Select * From Equipo Where idsubcategoria='5'"
