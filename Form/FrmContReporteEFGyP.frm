...
Begin VB.Form FrmContReporteEFGyP 
   BackColor       =   &H00EAEFEF&
   ...
   ClientTop       =   450
   ClientWidth     =   6945
   Icon            =   "FrmContReporteEFGyP.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   3945
   ScaleWidth      =   6945
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Combo1 
         Height          =   315
         ItemData        =   "FrmContReporteEFGyP.frx":1002
         Left            =   1920
         List            =   "FrmContReporteEFGyP.frx":1066
      ...
      Begin VB.ComboBox Combo2 
         Height          =   315
         ItemData        =   "FrmContReporteEFGyP.frx":10DF
         Left            =   1080
         List            =   "FrmContReporteEFGyP.frx":1143
         Locked          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   6
         Top             =   2160
      ...
      Begin VB.ComboBox Combo3 
         Height          =   315
         ItemData        =   "FrmContReporteEFGyP.frx":11BC
         Left            =   1080
         List            =   "FrmContReporteEFGyP.frx":121D
         Locked          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   5
         Top             =   2520
   ...
   Begin VB.Frame Frame2 
      ...
      Begin ChamaleonButton.ChameleonBtn BtnCerrar 
         ...
         MCOL            =   16777215
         MPTR            =   1
         MICON           =   "FrmContReporteEFGyP.frx":1294
         PICN            =   "FrmContReporteEFGyP.frx":12B0
         PICH            =   "FrmContReporteEFGyP.frx":1479
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonButton.ChameleonBtn BtnResultados 
         ...
         MCOL            =   16777215
         MPTR            =   1
         MICON           =   "FrmContReporteEFGyP.frx":16AE
         PICN            =   "FrmContReporteEFGyP.frx":16CA
         PICH            =   "FrmContReporteEFGyP.frx":195C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonButton.ChameleonBtn BtnGuardarActualizar 
         ...
         MCOL            =   16777215
         MPTR            =   1
         MICON           =   "FrmContReporteEFGyP.frx":1AE9
         PICN            =   "FrmContReporteEFGyP.frx":1B05
         PICH            =   "FrmContReporteEFGyP.frx":1D94
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "FrmContReporteEFGyP"
...
For i = 0 To Combo2.ListCount - 1
    If InStr(1, Combo2.List(i), Trim(RsTemp.Fields("CtaIngresos").Value)) = 1 Then
        Combo2.ListIndex = i
        Exit For
    End If
Next i
For i = 0 To Combo3.ListCount - 1
    If InStr(1, Combo3.List(i), Trim(RsTemp.Fields("CtaEgresos").Value)) = 1 Then
        Combo3.ListIndex = i
        Exit For
    End If
Next i
...
Else
    ...
    Dim CtaIngre As String
    Dim CtaEgres As String
    
    CtaIngre = Trim(Mid(Combo2.List(Combo2.ListIndex), 1, InStr(1, Combo2.List(Combo2.ListIndex), " ")))
    CtaEgres = Trim(Mid(Combo3.List(Combo3.ListIndex), 1, InStr(1, Combo3.List(Combo3.ListIndex), " ")))
    
    CSql = "UPDATE ContPDCConfig SET CtaIngresos='" & CtaIngre & "',CtaEgresos='" & CtaEgres & _
        "' WHERE IdEmpresa=" & IdEmprs
    Set RsTemp = CrearRS(CSql)
