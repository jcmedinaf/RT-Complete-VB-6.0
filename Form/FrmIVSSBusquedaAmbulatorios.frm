...
Begin VB.Form FrmIVSSBusquedaAmbulatorios 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Busqueda Ambulatorios"
   ClientHeight    =   8790
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   14895
   Icon            =   "FrmIVSSBusquedaAmbulatorios.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8790
   ...
   End
End
Attribute VB_Name = "FrmIVSSBusquedaAmbulatorios"
...
If TxtNombre.Text = "" And TxtCiudad.Text = "" And TxtEstado.Text = "" Then
    Msg = "Por favor ingrese Nombre del Ambulatorio o Ciudad o Estado para realizar una búsqueda"
...
CSql = "SELECT hospitales.idhospital, hospitales.hospital, hospitales.tipo, hospitales.direccion, hospitales.telefonos, ciudad.idciudad," & _
           ...
           "= estado.idestado WHERE" & wer & " And hospitales.tipo='2'"
